...
(
 ...
 wire [2:0] display_mode; wire [11:0] threshold_low,threshold_high;wire face_overrun;
 uart_params u_params(clk_pixel,rstn_pixel,uart_rx_i,display_mode,threshold_low,threshold_high);
 assign uart_tx_o=1'b1;
 assign led_o[4]=face_overrun;
 // lcd_driver DATA_WIDTH=48: the original 24-bit RGB occupies the low half.
 parallel_video u_parallel(clk_pixel,rstn_pixel,{lcd_red,lcd_green,lcd_blue},
 lcd_de,lcd_vs,lcd_hs,display_mode,threshold_low,threshold_high,
 face_overlay_rgb,face_overlay_de,face_overlay_vs,face_overlay_hs,face_overrun);
