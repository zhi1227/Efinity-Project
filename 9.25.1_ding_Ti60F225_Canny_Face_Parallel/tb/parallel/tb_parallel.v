...
module tb_parallel;
 ...
 reg rst=0,de=0,vs=0,hs=1;reg[23:0] rgb=0;reg[3:0] mode=0;
 wire[23:0] out_rgb;wire od,ov,oh,overrun;
 parallel_video #(.WIDTH(W),.HEIGHT(H),.H_TOTAL(HT)) dut(clk,rst,rgb,de,vs,hs,mode,12'd40,12'd80,out_rgb,od,ov,oh,overrun,1'b0);
