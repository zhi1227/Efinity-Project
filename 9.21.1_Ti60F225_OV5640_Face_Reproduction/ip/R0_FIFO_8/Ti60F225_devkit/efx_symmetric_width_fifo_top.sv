...
generate
    ...
    if (!SYNC_CLK) begin
        ...
        if (BYPASS_RESET_SYNC) begin
            ...
            efx_resetsync_f81c17844c0a4d5fa30d89ba7d75c52b #(
               .ACTIVE_LOW (0)
...
generate
    if (SYNC_CLK) begin : sync_clk
       if (MODE == "FWFT") begin
        ...
        efx_fifo_bin2gray_f81c17844c0a4d5fa30d89ba7d75c52b # (.WIDTH(RADDR_WIDTH+1)                                           ) xrd2wr_bin2gray    (.bin_i(raddr_cntr), .gray_o(raddr_cntr_gry));
        efx_asyncreg_f81c17844c0a4d5fa30d89ba7d75c52b      # (.ASYNC_STAGE(SYNC_STAGE), .WIDTH (RADDR_WIDTH+1), .ACTIVE_LOW(0)) xrd2wr_addr_sync   (.clk(wclk), .reset_n(wr_rst), .d_i(raddr_cntr_gry_r), .d_o(raddr_cntr_gry_sync));
        ...
        efx_asyncreg_f81c17844c0a4d5fa30d89ba7d75c52b      # (.ASYNC_STAGE(SYNC_STAGE), .WIDTH (WADDR_WIDTH+1), .ACTIVE_LOW(0)) wr2rd_addr_sync (.clk(rclk), .reset_n(rd_rst), .d_i(waddr_cntr_gry_r), .d_o(waddr_cntr_gry_sync));
...
module efx_resetsync_f81c17844c0a4d5fa30d89ba7d75c52b #(
...
generate
   if (ACTIVE_LOW == 1) begin: active_low
      efx_asyncreg_f81c17844c0a4d5fa30d89ba7d75c52b #(
         .WIDTH      (1),
         .ACTIVE_LOW (1),
         .RST_VALUE  (0)
...
module efx_asyncreg_f81c17844c0a4d5fa30d89ba7d75c52b #(
    parameter ASYNC_STAGE = 2,
    parameter WIDTH = 4,
